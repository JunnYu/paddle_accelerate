...
def get_train_dataloader(tokenizer, args):
    ...
    batch_sampler = DistributedBatchSampler(ds, batch_size=args.train_batch_size, shuffle=True)
...
def get_dev_dataloader(tokenizer, args):
    ...
    batch_sampler = DistributedBatchSampler(ds, batch_size=args.eval_batch_size, shuffle=False)
